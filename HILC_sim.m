...
fprintf('mean of the final state: %.2f\n', mean(xArr))
fprintf('variance of the final state: %.2f\n', var(xArr))
%% Visualization
figure('Visible','on')
